...
def read_source_data(ifc_path, xls_path):
    global conf_lst  # Nutze die globalen Variablen des Moduls

    #Alle Grundlagen einlesen > IFC + Excel-Elementplan

    print("Start: Starte Grunddatein einlesen...")

    source_folder = os.path.dirname(ifc_path)  # Extrahiere den Ordner aus dem IFC-Pfad
    xls_file_name = os.path.basename(xls_path)  # Extrahiere den Dateinamen aus dem XLS-Pfad
    ...
    if(check_file):
        ...
        print("Start:Konfigurationsdatei einlesen...")
